export { default as absorbAsReg } from './absorbAsReg';
...
export { default as cutStr } from './cutStr';
export { default as divArr } from './divArr';
export { default as divCount } from './divCount';
export { default as dlObjAsJson } from './dlObjAsJson';
...
export { default as isMtWithIdx } from './isMtWithIdx';
...
export { default as parseDom } from './parseDom';
